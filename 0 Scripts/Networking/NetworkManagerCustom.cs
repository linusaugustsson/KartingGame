...
public class NetworkManagerCustom : NetworkManager
{
    ...
    public void StartGame() {
        ...
        SoundManager.Instance.mainMenuMusic.Stop();

        CameraManager.Instance.ShowKartCamera();
    }
...
public override void OnServerAddPlayer(NetworkConnection conn) {
        ...
        GamePlayerInstance.transform.position = new Vector3(0.0f, 1005.0f, 0.0f);
        ...
        //Debug.Log(GamePlayerInstance.gameObject.name);
...
public override void OnClientDisconnect() {
        menuManager.SetActiveMenu(menuManager.mainMenuObject);
